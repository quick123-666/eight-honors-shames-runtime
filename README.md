<p align="center">
  ...
  <p align="center">
    <strong>规则注入省 97% · 真实工具环境可测 · 21 条准则单一来源</strong><br>
    <sub>注入成本为本机脚本实测（RULES.md 21 条，13,196 字符）；工具环境为真实 MiniMax-M3 agentic 循环结果</sub>
  </p>
</p>
...
八荣八耻 Runtime 把 [`RULES.md`](RULES.md)（项目 AI 协作纪律，21 条准则）升级为可运行的 Pi 扩展：
...
*MIT · 八荣八耻 Runtime v1.0.0 · 规则来源: RULES.md (21 条准则)*
